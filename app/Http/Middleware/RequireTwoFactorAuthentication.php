...
namespace DASHDACTYL\Http\Middleware;

use Illuminate\Support\Str;
use Illuminate\Http\Request;
use DASHDACTYL\Models\User;
use DASHDACTYL\Exceptions\Http\TwoFactorAuthRequiredException;
...
class RequireTwoFactorAuthentication
{
     ...
     *
     * @throws \DASHDACTYL\Exceptions\Http\TwoFactorAuthRequiredException
     */
    public function handle(Request $request, \Closure $next): mixed
    {
        ...
        $level = (int) config('DASHDACTYL.auth.2fa_required');
