...
namespace DASHDACTYL\Http\Controllers\Auth;
...
use DASHDACTYL\Http\Requests\Auth\LoginCheckpointRequest;
...
class LoginCheckpointController extends AbstractLoginController
{
    ...
    public function __invoke(LoginCheckpointRequest $request): JsonResponse
    {
        ...
        if (!is_null($recoveryToken = $request->input('recovery_token'))) {
            ...
            if ($this->google2FA->verifyKey($decrypted, $request->input('authentication_code') ?? '', config('DASHDACTYL.auth.2fa.window'))) {
