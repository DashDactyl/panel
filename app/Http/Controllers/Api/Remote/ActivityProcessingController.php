...
namespace DASHDACTYL\Http\Controllers\Api\Remote;
...
use DASHDACTYL\Models\ActivityLogSubject;
use DASHDACTYL\Http\Controllers\Controller;
use DASHDACTYL\Http\Requests\Api\Remote\ActivityEventRequest;
...
class ActivityProcessingController extends Controller
{
    public function __invoke(ActivityEventRequest $request)
    {
        ...
        foreach ($request->input('data') as $datum) {
            /** @var \DASHDACTYL\Models\Server|null $server */
