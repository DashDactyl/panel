...
namespace DASHDACTYL\Http\Controllers\Api\Remote\Backups;
...
use DASHDACTYL\Extensions\Backups\BackupManager;
use DASHDACTYL\Extensions\Filesystem\S3Filesystem;
use DASHDACTYL\Exceptions\Http\HttpForbiddenException;
use Symfony\Component\HttpKernel\Exception\BadRequestHttpException;
use DASHDACTYL\Http\Requests\Api\Remote\ReportBackupCompleteRequest;
...
class BackupStatusController extends Controller
{
    ...
    public function index(ReportBackupCompleteRequest $request, string $backup): JsonResponse
    {
        ...
        /** @var \DASHDACTYL\Models\Backup $model */
        $model = Backup::query()
            ->where('uuid', $backup)
            ->firstOrFail();
