...
use DASHDACTYL\Services\Eggs\EggConfigurationService;
use DASHDACTYL\Repositories\Eloquent\ServerRepository;
use DASHDACTYL\Http\Resources\Wings\ServerConfigurationCollection;
use DASHDACTYL\Services\Servers\ServerConfigurationStructureService;
    ...
    public function resetState(Request $request): JsonResponse
    {
        ...
        $this->connection->transaction(function () use ($node, $servers) {
            ...
            foreach ($servers as $server) {
                /** @var \DASHDACTYL\Models\ActivityLog|null $activity */
