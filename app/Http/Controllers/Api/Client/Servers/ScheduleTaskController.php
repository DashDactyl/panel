...
use DASHDACTYL\Exceptions\Http\HttpForbiddenException;
use DASHDACTYL\Transformers\Api\Client\TaskTransformer;
use DASHDACTYL\Http\Requests\Api\Client\ClientApiRequest;
use DASHDACTYL\Http\Controllers\Api\Client\ClientApiController;
use DASHDACTYL\Exceptions\Service\ServiceLimitExceededException;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Schedules\StoreTaskRequest;
...
class ScheduleTaskController extends ClientApiController
{
     ...
     * @throws \DASHDACTYL\Exceptions\Service\ServiceLimitExceededException
     */
    public function store(StoreTaskRequest $request, Server $server, Schedule $schedule): array
    {
        $limit = config('DASHDACTYL.client_features.schedules.per_schedule_task_limit', 10);
        ...
        /** @var \DASHDACTYL\Models\Task|null $lastTask */
