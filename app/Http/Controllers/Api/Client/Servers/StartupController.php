...
use DASHDACTYL\Services\Servers\StartupCommandService;
use DASHDACTYL\Repositories\Eloquent\ServerVariableRepository;
use DASHDACTYL\Transformers\Api\Client\EggVariableTransformer;
use DASHDACTYL\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\BadRequestHttpException;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Startup\GetStartupRequest;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Startup\UpdateStartupVariableRequest;
...
class StartupController extends ClientApiController
{
    ...
    public function update(UpdateStartupVariableRequest $request, Server $server): array
    {
        ...
        /* @var \DASHDACTYL\Models\EggVariable $variable */
