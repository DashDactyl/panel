...
use DASHDACTYL\Helpers\Utilities;
use DASHDACTYL\Exceptions\DisplayException;
use DASHDACTYL\Repositories\Eloquent\ScheduleRepository;
use DASHDACTYL\Services\Schedules\ProcessScheduleService;
use DASHDACTYL\Transformers\Api\Client\ScheduleTransformer;
use DASHDACTYL\Http\Controllers\Api\Client\ClientApiController;
use Symfony\Component\HttpKernel\Exception\NotFoundHttpException;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Schedules\ViewScheduleRequest;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Schedules\StoreScheduleRequest;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Schedules\DeleteScheduleRequest;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Schedules\UpdateScheduleRequest;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Schedules\TriggerScheduleRequest;
...
class ScheduleController extends ClientApiController
{
    ...
    {
        /** @var \DASHDACTYL\Models\Schedule $model */
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule): array
    {
        ...
        //
        // @see https://github.com/DASHDACTYL/panel/issues/2425
