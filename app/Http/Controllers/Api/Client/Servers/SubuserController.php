...
use DASHDACTYL\Services\Subusers\SubuserCreationService;
use DASHDACTYL\Repositories\Wings\DaemonServerRepository;
use DASHDACTYL\Transformers\Api\Client\SubuserTransformer;
...
use DASHDACTYL\Http\Requests\Api\Client\Servers\Subusers\GetSubuserRequest;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Subusers\StoreSubuserRequest;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Subusers\DeleteSubuserRequest;
use DASHDACTYL\Http\Requests\Api\Client\Servers\Subusers\UpdateSubuserRequest;
...
class SubuserController extends ClientApiController
{
    ...
    {
        /** @var \DASHDACTYL\Models\Subuser $subuser */
        $subuser = $request->attributes->get('subuser');
