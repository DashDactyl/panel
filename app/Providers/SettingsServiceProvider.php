...
class SettingsServiceProvider extends ServiceProvider
{
    ...
    protected array $keys = [
        ...
        'DASHDACTYL:guzzle:timeout',
        'DASHDACTYL:guzzle:connect_timeout',
        'DASHDACTYL:console:count',
        'DASHDACTYL:console:frequency',
        'DASHDACTYL:auth:2fa_required',
        'DASHDACTYL:client_features:allocations:enabled',
        'DASHDACTYL:client_features:allocations:range_start',
        'DASHDACTYL:client_features:allocations:range_end',
    ];
