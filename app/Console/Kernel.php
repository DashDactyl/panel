...
namespace DASHDACTYL\Console;

use Ramsey\Uuid\Uuid;
use DASHDACTYL\Models\ActivityLog;
...
use DASHDACTYL\Console\Commands\Schedule\ProcessRunnableCommand;
use DASHDACTYL\Console\Commands\Maintenance\PruneOrphanedBackupsCommand;
use DASHDACTYL\Console\Commands\Maintenance\CleanServiceBackupFilesCommand;
...
class Kernel extends ConsoleKernel
{
    ...
    protected function schedule(Schedule $schedule): void
    {
        ...
        if (config('DASHDACTYL.telemetry.enabled')) {
