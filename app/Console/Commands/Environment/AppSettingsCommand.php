...
namespace DASHDACTYL\Console\Commands\Environment;

use Illuminate\Console\Command;
use Illuminate\Contracts\Console\Kernel;
use DASHDACTYL\Traits\Commands\EnvironmentWriterTrait;
...
class AppSettingsCommand extends Command
{
     ...
     *
     * @throws \DASHDACTYL\Exceptions\DASHDACTYLException
     */
    public function handle(): int
    {
        ...
        $this->variables['APP_SERVICE_AUTHOR'] = $this->option('author') ?? $this->ask(
            'Egg Author Email',
            config('DASHDACTYL.service.author', 'unknown@unknown.com')
        );
        ...
        $this->output->comment('Please reference https://DASHDACTYL.io/panel/1.0/additional_configuration.html#telemetry for more detailed information regarding telemetry data and collection.');
        $this->variables['DASHDACTYL_TELEMETRY_ENABLED'] = $this->option('telemetry') ?? $this->confirm(
            'Enable sending anonymous telemetry data?',
            config('DASHDACTYL.telemetry.enabled', true)
        ) ? 'true' : 'false';
