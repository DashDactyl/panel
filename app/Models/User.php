...
use DASHDACTYL\Models\Traits\HasAccessTokens;
use Illuminate\Auth\Passwords\CanResetPassword;
use Illuminate\Database\Eloquent\Casts\Attribute;
use Illuminate\Database\Eloquent\Relations\HasOne;
use DASHDACTYL\Traits\Helpers\AvailableLanguages;
...
use DASHDACTYL\Notifications\SendPasswordReset as ResetPasswordNotification;

/**
 * DASHDACTYL\Models\User.
 *
 * @property int $id
 ...
 * @property string $md5
 * @property \DASHDACTYL\Models\AdminRole|null $adminRole
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\ApiKey[] $apiKeys
 * @property int|null $api_keys_count
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\RecoveryToken[] $recoveryTokens
 * @property int|null $recovery_tokens_count
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\Server[] $servers
 * @property int|null $servers_count
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\UserSSHKey[] $sshKeys
 * @property int|null $ssh_keys_count
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\ApiKey[] $tokens
