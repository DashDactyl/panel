...
use DASHDACTYL\Exceptions\Http\Server\ServerStateConflictException;

/**
 * \DASHDACTYL\Models\Server.
 *
 * @property int $id
 ...
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\ActivityLog[] $activity
 * @property int|null $activity_count
 * @property \DASHDACTYL\Models\Allocation|null $allocation
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\Allocation[] $allocations
 * @property int|null $allocations_count
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\Backup[] $backups
 * @property int|null $backups_count
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\Database[] $databases
 * @property int|null $databases_count
 * @property \DASHDACTYL\Models\Egg|null $egg
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\Mount[] $mounts
 * @property int|null $mounts_count
 * @property \DASHDACTYL\Models\Location $location
 * @property \DASHDACTYL\Models\Nest $nest
 * @property \DASHDACTYL\Models\Node $node
 * @property \Illuminate\Notifications\DatabaseNotificationCollection|\Illuminate\Notifications\DatabaseNotification[] $notifications
 * @property int|null $notifications_count
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\Schedule[] $schedules
 * @property int|null $schedules_count
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\Subuser[] $subusers
 * @property int|null $subusers_count
 * @property \DASHDACTYL\Models\ServerTransfer|null $transfer
 * @property \DASHDACTYL\Models\User $user
 * @property \Illuminate\Database\Eloquent\Collection|\DASHDACTYL\Models\EggVariable[] $variables
...
class Server extends Model
{
    ...
    public function variables(): HasMany
    {
        return $this->hasMany(EggVariable::class, 'egg_id', 'egg_id')
            ...
            ->leftJoin('server_variables', function (JoinClause $join) {
                ...
                //
                // @see https://github.com/DASHDACTYL/panel/issues/2250
     ...
     *
     * @throws \DASHDACTYL\Exceptions\Http\Server\ServerStateConflictException
     */
