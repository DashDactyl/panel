...
namespace DASHDACTYL\Services\Databases;
...
use DASHDACTYL\Extensions\DynamicDatabaseConnection;
use DASHDACTYL\Repositories\Eloquent\DatabaseRepository;
use DASHDACTYL\Exceptions\Repository\DuplicateDatabaseNameException;
use DASHDACTYL\Exceptions\Service\Database\TooManyDatabasesException;
use DASHDACTYL\Exceptions\Service\Database\DatabaseClientFeatureNotEnabledException;
...
class DatabaseManagementService
{
     ...
     *
     * @see \DASHDACTYL\Services\Databases\DatabaseManagementService::generateUniqueDatabaseName()
     */
    ...
    {
        if (!config('DASHDACTYL.client_features.databases.enabled')) {
     ...
     *
     * @throws \DASHDACTYL\Exceptions\Repository\DuplicateDatabaseNameException
     * @throws \Throwable
     */
