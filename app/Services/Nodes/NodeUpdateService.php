...
namespace DASHDACTYL\Services\Nodes;
...
use DASHDACTYL\Repositories\Wings\DaemonConfigurationRepository;
use DASHDACTYL\Exceptions\Http\Connection\DaemonConnectionException;
use DASHDACTYL\Exceptions\Service\Node\ConfigurationNotPersistedException;
...
class NodeUpdateService
{
    ...
    public function handle(Node $node, array $data, bool $resetToken = false): Node
    {
        ...
        [$updated, $exception] = $this->connection->transaction(function () use ($data, $node) {
            /** @var \DASHDACTYL\Models\Node $updated */
            ...
            try {
                ...
                //
                // @see https://github.com/DASHDACTYL/panel/issues/1931
                ...
                //
                // @see https://github.com/DASHDACTYL/panel/issues/2712
                return [$updated, true];
            }
