...
namespace DASHDACTYL\Services\Telemetry;
...
class TelemetryCollectionService
{
    ...
    /**
     * Collects telemetry data and sends it to the DASHDACTYL Telemetry Service.
     */
    public function __invoke(): void
    {
        ...
        Http::post('https://telemetry.DASHDACTYL.io', $data);
    }
