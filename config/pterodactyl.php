...
return [
    ...
    */
    ...
    | standard DASHDACTYL shipped services.
    */
    ...
    */
    ...
    'cdn' => [
        'cache_time' => 60,
        'url' => 'https://cdn.DASHDACTYL.io/releases/latest.json',
    ],
    ...
    */
    ...
    'client_features' => [
        'databases' => [
            'enabled' => env('DASHDACTYL_CLIENT_DATABASES_ENABLED', true),
            'allow_random' => env('DASHDACTYL_CLIENT_DATABASES_ALLOW_RANDOM', true),
        ],

        'schedules' => [
            // The total number of tasks that can exist for any given schedule at once.
            'per_schedule_task_limit' => env('DASHDACTYL_PER_SCHEDULE_TASK_LIMIT', 10),
        ],

        'allocations' => [
            'enabled' => env('DASHDACTYL_CLIENT_ALLOCATIONS_ENABLED', false),
            'range_start' => env('DASHDACTYL_CLIENT_ALLOCATIONS_RANGE_START'),
            'range_end' => env('DASHDACTYL_CLIENT_ALLOCATIONS_RANGE_END'),
        ],
    ],
    ...
    */
    ...
    'files' => [
        'max_edit_size' => env('DASHDACTYL_FILES_MAX_EDIT_SIZE', 1024 * 1024 * 4),
    ],
    ...
    */
    ...
    'assets' => [
        'use_hash' => env('DASHDACTYL_USE_ASSET_HASH', false),
    ],
    ...
    */
    ...
    'email' => [
        ...
        'send_install_notification' => env('DASHDACTYL_SEND_INSTALL_NOTIFICATION', true),
        // Should an email be sent to a server owner whenever their server is reinstalled?
        'send_reinstall_notification' => env('DASHDACTYL_SEND_REINSTALL_NOTIFICATION', true),
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | This section controls the telemetry sent by DASHDACTYL.
    */

    'telemetry' => [
        'enabled' => env('DASHDACTYL_TELEMETRY_ENABLED', true),
    ],
];