...
namespace DASHDACTYL\Tests\Unit\Http\Middleware\Api\Daemon;
...
use DASHDACTYL\Tests\Unit\Http\Middleware\MiddlewareTestCase;
...
class DaemonAuthenticateTest extends MiddlewareTestCase
{
    ...
    public function testResponseShouldFailIfTokenIsNotValid()
    {
        ...
        /** @var \DASHDACTYL\Models\Node $model */
