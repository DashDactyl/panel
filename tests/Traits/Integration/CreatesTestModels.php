...
namespace DASHDACTYL\Tests\Traits\Integration;
...
trait CreatesTestModels
{
     ...
     *
     * @return array{\DASHDACTYL\Models\User, \DASHDACTYL\Models\Server}
     */
    ...
    protected function cloneEggAndVariables(Egg $egg): Egg
    {
        ...
        /** @var \DASHDACTYL\Models\Egg $model */
        $model = $model->fresh();
    ...
    {
        /** @var \DASHDACTYL\Models\Egg $egg */
        $egg = Egg::query()->where('author', 'support@DASHDACTYL.io')->where('name', 'Bungeecord')->firstOrFail();
