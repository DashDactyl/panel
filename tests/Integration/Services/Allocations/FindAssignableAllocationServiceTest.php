...
namespace DASHDACTYL\Tests\Integration\Services\Allocations;
...
use DASHDACTYL\Exceptions\Service\Allocation\AutoAllocationNotEnabledException;
use DASHDACTYL\Exceptions\Service\Allocation\NoAutoAllocationSpaceAvailableException;
...
class FindAssignableAllocationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        config()->set('DASHDACTYL.client_features.allocations.enabled', true);
        config()->set('DASHDACTYL.client_features.allocations.range_start', 0);
        config()->set('DASHDACTYL.client_features.allocations.range_end', 0);
    }
    ...
    {
        $server = $this->createServerModel();
        config()->set('DASHDACTYL.client_features.allocations.range_start', 5000);
        config()->set('DASHDACTYL.client_features.allocations.range_end', 5005);
    ...
    public function testOnlyPortNotInUseIsCreated()
    {
        ...
        config()->set('DASHDACTYL.client_features.allocations.range_start', 5000);
        config()->set('DASHDACTYL.client_features.allocations.range_end', 5001);
    ...
    {
        $server = $this->createServerModel();
        config()->set('DASHDACTYL.client_features.allocations.range_start', 'hodor');
        config()->set('DASHDACTYL.client_features.allocations.range_end', 10);
        ...
        config()->set('DASHDACTYL.client_features.allocations.range_start', 10);
        config()->set('DASHDACTYL.client_features.allocations.range_end', 'hodor');
    ...
    {
        config()->set('DASHDACTYL.client_features.allocations.enabled', false);
        $server = $this->createServerModel();
