...
namespace DASHDACTYL\Tests\Integration\Services\Deployment;
...
use DASHDACTYL\Exceptions\Service\Deployment\NoViableNodeException;
...
class FindViableNodesServiceTest extends IntegrationTestCase
{
     ...
     *
     * @see https://github.com/DASHDACTYL/panel/issues/2529
     */
    ...
    {
        /** @var \DASHDACTYL\Models\Location[] $locations */
        $locations = Location::factory()->times(2)->create();

        /** @var \DASHDACTYL\Models\Node[] $nodes */
        $nodes = [
