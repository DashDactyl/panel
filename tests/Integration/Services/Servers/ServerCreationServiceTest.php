...
namespace DASHDACTYL\Tests\Integration\Services\Servers;
...
use DASHDACTYL\Models\Objects\DeploymentObject;
...
class ServerCreationServiceTest extends IntegrationTestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->bungeecord = Egg::query()
            ->where('author', 'support@DASHDACTYL.io')
    ...
    {
        /** @var \DASHDACTYL\Models\User $user */
        $user = User::factory()->create();

        /** @var \DASHDACTYL\Models\Location $location */
        $location = Location::factory()->create();

        /** @var \DASHDACTYL\Models\Node $node */
        $node = Node::factory()->create([
            'location_id' => $location->id,
        ]);

        /** @var \DASHDACTYL\Models\Allocation[]|\Illuminate\Database\Eloquent\Collection $allocations */
