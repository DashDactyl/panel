...
use DASHDACTYL\Tests\Integration\TestResponse;
...
abstract class ClientApiIntegrationTestCase extends IntegrationTestCase
{
    ...
    protected function assertJsonTransformedWith(array $data, Model|EloquentModel $model)
    {
        ...
        $transformer = sprintf('\\DASHDACTYL\\Transformers\\Api\\Client\\%sTransformer', $reflect->getShortName());
