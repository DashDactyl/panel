...
namespace DASHDACTYL\Tests\Integration\Api\Client;
...
class ApiKeyControllerTest extends ClientApiIntegrationTestCase
{
    ...
    public function testApiKeysAreReturned()
    {
        ...
        /** @var \DASHDACTYL\Models\ApiKey $key */
     ...
     *
     * @see https://github.com/DASHDACTYL/panel/security/advisories/GHSA-pjmh-7xfm-r4x9
     * @see https://github.com/DASHDACTYL/panel/issues/4394
     */
     ...
     *
     * @see https://github.com/DASHDACTYL/panel/issues/2457
     */
    ...
    public function testApiKeyBelongingToAnotherUserCannotBeDeleted()
    {
        /** @var \DASHDACTYL\Models\User $user */
        $user = User::factory()->create();
        /** @var \DASHDACTYL\Models\User $user2 */
